...
path.5558hb.s3e <- file.path("/dcl02/lieber/ajaffe/ErikNelson/Habenula/Br5558/outs/raw_feature_bc_matrix/")
s3e.hb.5558 <- read10xCounts(path.5558hb.s3e, col.names=TRUE)
s3e.hb.5558

path.1204hb.s3e <- file.path("/dcl02/lieber/ajaffe/ErikNelson/Habenula/Br1204/outs/raw_feature_bc_matrix/")
s3e.hb.1204 <- read10xCounts(path.1204hb.s3e, col.names=TRUE)
s3e.hb.1204

path.5639hb.s3e <- file.path("/dcl02/lieber/ajaffe/ErikNelson/Habenula/Br5639/outs/raw_feature_bc_matrix/")
s3e.hb.5639 <- read10xCounts(path.5639hb.s3e, col.names=TRUE)
s3e.hb.5639

path.1735hb.s3e <- file.path("/dcl02/lieber/ajaffe/ErikNelson/Habenula/Br1735/outs/raw_feature_bc_matrix/")
s3e.hb.1735 <- read10xCounts(path.1735hb.s3e, col.names=TRUE)
s3e.hb.1735

path.1092hb.s3e <- file.path("/dcl02/lieber/ajaffe/ErikNelson/Habenula/Br1092/outs/raw_feature_bc_matrix/")
s3e.hb.1092 <- read10xCounts(path.1092hb.s3e, col.names=TRUE)
s3e.hb.1092

#path.5555hb.s3e <- file.path("/dcl02/lieber/ajaffe/ErikNelson/Habenula/Br5555/outs/raw_feature_bc_matrix/")
#s3e.hb.5555 <- read10xCounts(path.5555hb.s3e, col.names=TRUE)
#s3e.hb.5555

path.1469hb.s3e <- file.path("/dcl02/lieber/ajaffe/ErikNelson/Habenula/Br1469/outs/raw_feature_bc_matrix/")
