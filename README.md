...
These images were analyzed with HALO software (Indica labs), settings files & tabular output of the HALO analysis are available in [`processed-data/14_RNAscope/HALO_data`](https://github.com/LieberInstitute/Habenula_Pilot/tree/master/processed-data/14_RNAscope/HALO_data/HALO_settingfiles).
