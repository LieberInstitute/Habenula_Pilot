...
## mdd2019edinburgh
magma --gene-results ../../processed-data/13_MAGMA/GWAS/mdd2019edinburgh/PGC_UKB_depression_genome-wide.genes.raw\
...
## panic2019
magma --gene-results ../../processed-data/13_MAGMA/GWAS/panic2019/pgc-panic2019.genes.raw\
	--set-annot ../../processed-data/13_MAGMA/gene_sets/markerSets_broad_combo_ENSEMBL_FDR05.txt gene-col=Gene set-col=Set\
	--out ../../processed-data/13_MAGMA/MAGMA_output/panic2019/panic2019_broad_combo

## scz2022
magma --gene-results ../../processed-data/13_MAGMA/GWAS/scz2022/PGC3_SCZ_wave3.european.autosome.public.v3.genes.raw\
	--set-annot ../../processed-data/13_MAGMA/gene_sets/markerSets_broad_combo_ENSEMBL_FDR05.txt gene-col=Gene set-col=Set\
	--out ../../processed-data/13_MAGMA/MAGMA_output/scz2022/scz2022_broad_combo

## sud2020op
magma --gene-results ../../processed-data/13_MAGMA/GWAS/sud2020op/opi.DEPvEXP_EUR.noAF.genes.raw\
	--set-annot ../../processed-data/13_MAGMA/gene_sets/markerSets_broad_combo_ENSEMBL_FDR05.txt gene-col=Gene set-col=Set\
