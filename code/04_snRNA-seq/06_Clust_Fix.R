## 2/14/23 - Bukola Ajanaku
## Figuring out what happened to my clusters and why the heatmap is giving wrong annotations.
...
# Terminal 1 sce object: (plots are _test1)
load(here("processed-data", "04_snRNA-seq", "sce_objects", 
                                "sce_mid_clustering.Rdata"))
sce


# Terminal 2 sce object:  (plots are _test2)
load(here("processed-data", "04_snRNA-seq", "sce_objects", 
...
pdf(file = here("plots", "04_snRNA-seq", "06_Clustering", "test", "TSNE_clusters_unfinalized_test1.pdf"),
    height = 6,  width = 13)
...
pdf(file = here("plots", "04_snRNA-seq", "06_Clustering", "test", "UMAP_clusters_unfinalized_test1.pdf"),
    height = 7, width = 12)
...
############# HEATMAPS #########################################################
pdf(here("plots", "04_snRNA-seq", "06_Clustering", "test",
         "Heatmap_Clusters_unfinalized_test1.pdf"), height = 7, width = 7)
