...
# to validate probe their identities and investigate if any further collapses are necessary.
      ...
      # ## 2) Create heatmap that doesn't split by Sample. [Working on new pseudobulk]
      # ## 3) Hockey Stick plots (from Zoom meeting with Louise slacked in Habenula chat.)
      # ## 4) VP1: Grab list of genes from Dr. Maynard for violin plots in Hb cells (violin plots) ** waiting
      # ## 5) VP3: Merge MHB 2 and 3 to see what we get (1 and 4 look very specific) and re-run mean ratio expression.
      # ## 6) VP4: Do regular thalamic and habenula genes on Hb cluster violin plots.
...
"Habenula" = c("Ccbp2","Cd63", "Htr5b", "Kcnh8", "Kctd8", "Lrrc55", "Mapk4", "Neurod1", 
              "Pixnc1", "Scube1", "Sstr4", "Tacr1", "Sstr2", "Irx2"),
"LHB_specific" = c("Pcdh10", "Gabra1", "Syn2", "Gap43", "Htr2c", "Adcyap1r1", 
                     "Chrm3", "Vgf", "Gpr151", "Sst", "Slc17ar"),
"MHb_specific" = c("Tac3", "Spon1", "Sema3d", "Calb1",'Htr5b', "Cnr1", "Gpr4", "Chrnb3", "B4",
                   "Slc17a7"),
